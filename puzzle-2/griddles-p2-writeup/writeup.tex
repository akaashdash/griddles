...
\begin{figure}[h]
  ...
  \caption{The decoded $4\times 4$ pandiagonal magic square.
    Cell colour indicates continental region.
    Cells with calendar-system encodings show the encoded
    label in italic; the mystery cell (gold) is revealed
    as ordinal 26.  All rows and columns sum to $M=98$
    (annotations on edges); both main diagonals (dashed)
    and all broken diagonals also sum to 98.}
  \label{fig:magic}
\end{figure}
