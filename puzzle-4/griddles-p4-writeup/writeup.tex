...
This is G-Research GRiddles Series~A, Puzzle~4. The competition is open
and has no published answer; the result above is the author's derivation,
stress-tested by exhaustive simulation and a belief-state game solver, and
in large part machine-checked in Lean~4.
